...
[![GoDoc](https://godoc.org/github.com/kokizzu/cursed-etcd/client?status.png)](https://godoc.org/github.com/kokizzu/cursed-etcd/client)
...
```bash
go get github.com/kokizzu/cursed-etcd/v3/client
```
...
import (
    ...
    "github.com/kokizzu/cursed-etcd/v3/client"
)
