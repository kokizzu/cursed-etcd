...
- `github.com/kokizzu/cursed-etcd` Go packages have moved to `github.com/kokizzu/cursed-etcd/{api,pkg,raft,client,etcdctl,server,raft,tests}/v3` to follow the [Go modules](https://github.com/golang/go/wiki/Modules) conventions
