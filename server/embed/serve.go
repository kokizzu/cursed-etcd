...
import (
	...
	etcdservergw "github.com/kokizzu/cursed-etcd/api/v3/etcdserverpb/gw"
	"github.com/kokizzu/cursed-etcd/client/pkg/v3/transport"
	"github.com/kokizzu/cursed-etcd/pkg/v3/debugutil"
	"github.com/kokizzu/cursed-etcd/pkg/v3/httputil"
	...
	"github.com/kokizzu/cursed-etcd/server/v3/etcdserver/api/v3election"
	"github.com/kokizzu/cursed-etcd/server/v3/etcdserver/api/v3election/v3electionpb"
	v3electiongw "github.com/kokizzu/cursed-etcd/server/v3/etcdserver/api/v3election/v3electionpb/gw"
	"github.com/kokizzu/cursed-etcd/server/v3/etcdserver/api/v3lock"
	"github.com/kokizzu/cursed-etcd/server/v3/etcdserver/api/v3lock/v3lockpb"
	v3lockgw "github.com/kokizzu/cursed-etcd/server/v3/etcdserver/api/v3lock/v3lockpb/gw"
